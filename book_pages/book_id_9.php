...
<body>
    <div class="container">
        <h1>The Never Girls From The Mist</h1>
        <img src="images/the never girls front page.jpg" alt="Book back cover">
        <img src="images/the never girls back page.jpg" alt="Book front cover">
