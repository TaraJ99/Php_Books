...
<body>
    <div class="container">
        <h1>Mega Mean Time Machine</h1>
        <img src="images/time machine front page.jpg" alt="Book back cover">
        <img src="images/time machine back page.jpg" alt="Book front cover">
