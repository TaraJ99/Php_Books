...
<body>
    <div class="container">
        <h1>The naughtiest girl want to win</h1>
        <img src="images/she wants to win front page.jpg" alt="Book back cover">
        <img src="images/she wants to win back page.jpg" alt="Book front cover">
