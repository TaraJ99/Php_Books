...
<body>
    <div class="container">
        <h1>A tiny bit lucky</h1>
        <img src="images/a tiny bit lucky front page.jpg" alt="Book back cover">
        <img src="images/a tiny bit lucky back page.jpg" alt="Book front cover">
